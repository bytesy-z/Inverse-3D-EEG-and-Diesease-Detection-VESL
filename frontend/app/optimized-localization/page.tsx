...
export default function OptimizedLocalizationPage() {
  return (
    <main className="min-h-screen w-full flex flex-col bg-[#1f2937] text-foreground">
      ...
      <nav className="w-full bg-[#181c1f] border-b border-gray-800 shadow flex items-center px-6 py-3 z-20 sticky top-0">
        ...
        <div className="flex items-center gap-6">
          ...
          <span className="font-semibold px-4 py-2 rounded bg-gray-800 text-[var(--chart-4)]">Optimized Localization</span>
        </div>
      </nav>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        <div className="text-center max-w-2xl">
          ...
          <h1 className="text-4xl font-bold mb-4 text-white">Optimized Localization</h1>
          ...
          <div className="bg-[#181c1f] border border-gray-700 rounded-xl p-6 mb-8">
            ...
            <ul className="text-left text-gray-300 space-y-2">
              <li>• Advanced optimization algorithms for source localization</li>
              <li>• Improved accuracy with regularization techniques</li>
              <li>• Customizable parameters for different use cases</li>
              <li>• Comparison with standard localization methods</li>
            </ul>
          </div>
